            ...
            <main class="admin-content">
                ...
                <div class="card admin-table-card">
                    <div class="card-body">
                        <form action="proFunctions/insert.php" method="post" enctype="multipart/form-data">
                            <div class="row g-3">
                            ...
                            <!-- name -->
                                <div class="col-md-6">
                                    ...
                                    <input name="name" type="text" class="form-control" id="userName" placeholder="Product Name">
                                    <?php error('name') ?>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="sale" type="number" class="form-control" id="Sale" placeholder="Product Sale">
                                    <?php error('sale') ?>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="count" type="number" class="form-control" id="Count" placeholder="Product Count">
                                    <?php error('count') ?>
                                </div>
