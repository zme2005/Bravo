  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Are you sure that you want to delete the <span class="text-danger"><?= $value["name"] ?></span> category?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <a href="catFunctions/delete.php?delCat=<?= $value["id"] ?>" class="btn btn btn-danger">Delete</a>
      </div>
    </div>
  </div>
</div>
